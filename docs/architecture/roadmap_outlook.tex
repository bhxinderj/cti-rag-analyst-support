...
\node[stage, fill=black!10] (s1) {%
    ...
    {\small Deterministic fact tool as the safe default for agentic
     ...
     (P6)}};
\node[stage, fill=black!25, below=4.5mm of s1] (s2) {%
    ...
    {\small Scheduled re-indexing of the curated sources as versioned
     ...
     reproducibility}};
\node[stage, fill=black!48, text=white, below=4.5mm of s2] (s3) {%
...
\node[stage, fill=black!70, text=white, below=4.5mm of s3] (s4) {%
